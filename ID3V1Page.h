...
#if !defined(AFX_ID3V1PAGE_H__361B53EB_D044_4AC7_A732_4859D19957B8__INCLUDED_)
#define AFX_ID3V1PAGE_H__361B53EB_D044_4AC7_A732_4859D19957B8__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// ID3V1Page.h : header file
//
#include "resource.h"
...
class CID3V1Page : public CDialog
{
// Construction
...
public:
	...
	CID3V1Page(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CID3V1Page)
	enum { IDD = IDD_ID3V1_DIALOG };
	CButton	m_Trackchk;
	CEdit	m_Track;
	CButton	m_Yearchk;
	CButton	m_Titlechk;
...
#endif // !defined(AFX_ID3V1PAGE_H__361B53EB_D044_4AC7_A732_4859D19957B8__INCLUDED_)
