// PrefsID3V2HidePage.cpp : implementation file
...
/////////////////////////////////////////////////////////////////////////////
// CPrefsID3V2HidePage dialog


CPrefsID3V2HidePage::CPrefsID3V2HidePage(CWnd* pParent /*=NULL*/)
	: CSAPrefsSubDlg(CPrefsID3V2HidePage::IDD, pParent)
{
	//{{AFX_DATA_INIT(CPrefsID3V2HidePage)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void CPrefsID3V2HidePage::DoDataExchange(CDataExchange* pDX)
{
	CSAPrefsSubDlg::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPrefsID3V2HidePage)
...
BEGIN_MESSAGE_MAP(CPrefsID3V2HidePage, CSAPrefsSubDlg)
	//{{AFX_MSG_MAP(CPrefsID3V2HidePage)
...
/////////////////////////////////////////////////////////////////////////////
// CPrefsID3V2HidePage message handlers
...
void CPrefsID3V2HidePage::getAddressMainDlg(CMp3tagtoolsDlg *pDlg)
{
	pMainDlg = pDlg;
	
}

void CPrefsID3V2HidePage::OnAddButton() 
{
...
void CPrefsID3V2HidePage::OnRemoveButton() 
{
...
void CPrefsID3V2HidePage::OnAddallButton() 
{
	int ncount = m_hidecollistbox.GetCount();
...
void CPrefsID3V2HidePage::OnRemoveallButton() 
{
	int ncount = m_showcollistbox.GetCount();
	if (ncount>0||ncount != LB_ERR)
	{
...
void CPrefsID3V2HidePage::OnUpButton() 
{
	int ncount = m_showcollistbox.GetCount();
	int nselcount = m_showcollistbox.GetSelCount();
	if (nselcount>0||nselcount != LB_ERR)
...
void CPrefsID3V2HidePage::OnDownButton() 
{
	int ncount = m_showcollistbox.GetCount();
	int nselcount = m_showcollistbox.GetSelCount();
	if (nselcount>0||nselcount != LB_ERR)
...
BOOL CPrefsID3V2HidePage::OnHelpInfo(HELPINFO* pHelpInfo) 
{
	ShowHelp();
	return TRUE;
}

BOOL CPrefsID3V2HidePage::OnNotify(WPARAM wParam, LPARAM lParam, LRESULT* pResult) 
{
...
void CPrefsID3V2HidePage::ShowHelp()
{
